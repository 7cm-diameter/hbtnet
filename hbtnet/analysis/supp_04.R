...
sim_data_VR_VI <- read.csv("./data/supp_04_VR_VI.csv")
sim_data_choice <- read.csv("./data/supp_04_choice.csv")
...
# Figure 1
supp_04a <- show_devaluation_02(averaged_data_VR_VI)
supp_04b <- show_degree_02(averaged_data_VR_VI)
supp_04c <- show_centrality_02(averaged_data_VR_VI)

supp_04d <- ggplot(sim_data_choice) +
...
ggsave("./fig/supp_04a_devalue.jpg", supp_04a)
ggsave("./fig/supp_04b_degree.jpg", supp_04b)
ggsave("./fig/supp_04c_central.jpg", supp_04c)
ggsave("./fig/supp_04d_devalue.jpg", supp_04d)
